...
class ContactView(APIView):
    """
    POST /api/contact/
    Used by every contact form across the site. Saves the lead, links it to
    the visitor session, then sends the user a confirmation email and
    notifies the team -- both fire-and-forget so a flaky SMTP connection
    never turns into a failed form submission for the visitor.
    """
